...
public class Triangle {
    ...
    public Triangle(float x, float y) {
        for(int i = 0; i < triangleCoords.length / COORDS_PER_VERTEX; i++) {
            triangleCoords[i*COORDS_PER_VERTEX] = triangleCoords[i*COORDS_PER_VERTEX] + x;
            triangleCoords[i*COORDS_PER_VERTEX + 1] = triangleCoords[i*COORDS_PER_VERTEX + 1] + y;
        }
